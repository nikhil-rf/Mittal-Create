  ...
  return (
    <div className="min-h-screen bg-black text-white py-16 px-4 mt-20">
      <div className="max-w-6xl mx-auto mt-30">
        {/* White Chevron Down */}
        <div className="w-0 h-0 border-l-[80px] border-r-[80px] border-t-[50px] border-l-transparent border-r-transparent border-t-white mx-auto -mt-46" />
        ...
        <div className="lg:w-1/2">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-lg">
              ...
              excellence. This comprehensive guide provides proven strategies, real-world 
              case studies, and actionable insights for contact centre leaders 
              and professionals.
            </p>
            ...
            <div className="mb-8 text-left">
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-300">Strategic frameworks for contact centre optimization</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#D0A151] rounded-full"></div>
                  <span className="text-gray-300">Real-world case studies and best practices</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#D0A151] rounded-full"></div>
                  <span className="text-gray-300">Leadership techniques for team excellence</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#D0A151] rounded-full"></div>
                  <span className="text-gray-300">Technology integration and digital transformation</span>
                </li>
              </ul>
            </div>
