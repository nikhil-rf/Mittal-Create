        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-lg">
              Welcome to our podcast series dedicated to makers and entrepreneurs. Join 
              industry leaders and innovators as they share insights, stories, and practical 
              advice to inspire your journey. Whether you're building a startup or 
              launching your next big idea, these conversations offer valuable guidance 
