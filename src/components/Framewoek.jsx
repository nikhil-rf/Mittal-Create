...
const Framework = () => {
  return (
    <div className="relative bg-white min-h-screen text-center px-4 py-12 pt-30">
      ...
      <div className="h-1 bg-[#C0944B] w-2/3 mx-auto mb-8" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative w-20 h-20">
                <div className="absolute inset-0 bg-[#b68c3d] clip-hexagon" />
                    <div className="absolute inset-[4px] bg-white clip-hexagon flex items-center justify-center">
                        <span className="text-3xl font-bold text-[#b68c3d] z-10">B</span>
                    </div>
            ...
            <div className="bg-black text-white p-6 rounded-md w-full h-69 flex flex-col justify-start">
              <div className="mb-2 mt-5">
                <img src={icon} alt="Breakdown Icon" className="mx-auto h-13 w-13 mb-7" />
                <p className="text-[#CE9D4B] text-xs mb-1 text-center">"B" STANDS FOR</p>
                <h2 className="text-lg font-semibold mb-2">Breakdown</h2>
                <p className="text-sm text-center font-thin text-gray-300">
                  Through plans, you break down a <br /> process into small and identify the <br /> things you accomplish..
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative w-20 h-20">
              <div className="absolute inset-0 bg-[#b68c3d] clip-hexagon" />
                  <div className="absolute inset-[4px] bg-white clip-hexagon flex items-center justify-center">
                       <span className="text-3xl font-bold text-[#b68c3d] z-10">Λ</span>
                  </div>
                </div>

            <div className="bg-black text-white p-6 rounded-md w-full h-69 flex flex-col justify-start">
              <div className="mb-2 mt-5">
                <img src={icon2} alt="Analysis Icon" className="mx-auto h-13 w-13 mb-7" />
                <p className="text-[#CE9D4B] text-xs mb-1 text-center">"A" STANDS FOR</p>
                <h2 className="text-lg font-semibold mb-2">Analysis</h2>
                <p className="text-sm text-center font-thin text-gray-300">
                  Through Breakdown, Analyze your <br /> each problem your business is <br /> facing and find possible solution
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative w-20 h-20">
              <div className="absolute inset-0 bg-[#b68c3d] clip-hexagon" />
                  <div className="absolute inset-[4px] bg-white clip-hexagon flex items-center justify-center">
                       <span className="text-3xl font-bold text-[#b68c3d] z-10">D</span>
                  </div>
              </div>

            <div className="bg-black text-white p-6 rounded-md w-full h-69 flex flex-col justify-start">
              <div className="mb-2 mt-5">
                <img src={icon3} alt="Decision Icon" className="mx-auto h-13 w-13 mb-7" />
                <p className="text-[#CE9D4B] text-xs mb-1 text-center">"D" STANDS FOR</p>
      ...
      <button className="mt-10 bg-[#CE9D4B] text-white px-6 py-2 rounded-full font-semibold hover:bg-[#a27c35] transition">
        Learn More About Our Framework
      </button>
