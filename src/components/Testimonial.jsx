...
//           {/* Profile Card */}
//           <div className="bg-yellow-600 p-8 rounded-lg shadow-lg text-center text-white min-w-80">
//             <div className="mb-6">
//               <img
...
//             <div className="text-6xl text-black font-serif absolute -top-6 -left-4">"</div>
//             <p className="text-lg text-gray-800 leading-relaxed pl-8">
//               {testimonials[currentSlide].quote}
//             </p>
//             <div className="text-6xl text-black font-serif absolute -bottom-6 right-4 rotate-180">"</div>
//           </div>
//         </div>
